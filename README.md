...
| **anti-slop**       | Code Quality       | Full bundled Anti-Slop checks after edits, plus focused pre-edit guardrails, without repository lint setup.                                                       | [📖 Docs](./plugins/anti-slop/README.md)                |
