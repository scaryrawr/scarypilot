...
| **anti-slop**       | Code Quality       | Advisory TypeScript and JavaScript guidance that preserves type evidence and avoids lint-shaped workarounds without requiring repository onboarding.                  | [📖 Docs](./plugins/anti-slop/README.md)                |
| **azure-devops**    | DevOps             | Create, inspect, and pair-review Azure DevOps pull requests in a local canvas, drive them through completion, and manage Azure Boards work items.                       | [📖 Docs](./plugins/azure-devops/README.md)             |
