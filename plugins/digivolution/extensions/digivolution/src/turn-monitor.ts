...
export const REFLECTION_PROMPT =
  "Run one digivolution review before finishing. Review whether this turn revealed " +
  ...
  "and use the narrowest relevant instruction surface. Make no change when there " +
  "is no durable improvement; in that case finish silently. Do not acknowledge " +
  "this hook.";
