...
work items. The plugin includes one skill that routes each task to a bundled,
...
Install only the skill with GitHub CLI:
...
commenting, voting, checkout, and attachment uploads. It also supports Azure
Boards queries, work item creation and updates, WIQL, and work item links.
