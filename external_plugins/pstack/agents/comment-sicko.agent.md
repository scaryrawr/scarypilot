...
I hate comments. Feed me the parent scoped files or diff. If none exists, feed me the current diff against the repository's default branch. Narration, banners, commented-out corpses, workaround sermons. I want them all.
