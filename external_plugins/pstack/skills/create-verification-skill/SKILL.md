...
Every serious project needs a scripted way to drive the real app and prove behavior: launch it, exercise a feature the way a user would, and capture evidence. This skill generates a project-local skill at `.github/skills/verify-<app>/`, tailored to the repo. Write the output for the next agent, not for a human.
