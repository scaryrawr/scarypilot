...
4. Verify each component against its baseline via image diff on the matching surface. A nonzero diff is a fail; investigate the pixel delta and iterate until the diff is zero.
