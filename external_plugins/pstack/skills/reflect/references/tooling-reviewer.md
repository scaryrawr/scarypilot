...
- `Read` tool calls against any `SKILL.md` file (workspace `.github/skills/`, user-level `~/.agents/skills/`, or plugin-installed paths under `installed plugin paths under the Copilot plugin directory/`)
