...
- Session automation and event watchers provide the wake mechanism; they are host capabilities, not pstack skills. The [Autonomous run playbook](../../skills/poteto-mode/playbooks/autonomous-run.md) uses it to re-check the finish condition on events or a heartbeat.
